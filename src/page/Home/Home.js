  ...
  return (
    <div className="home-page-wraper">
      <div className="home-title">
        <h2 className="title">Getting Started with Frontend Career</h2>
        <p className="home-text">
          The purpose of this roadmap is to give you an idea about the frontend
          development. The road map will guide you if you are confused about
          what to learn next, rather than encouraging you to pick what is hype
          and trendy. You should grow some understanding of why one tool would
          be better suited for some cases than the other and remember that hype
          and trendy do not always mean best suited for the job.
        </p>
        <p className="home-text">
